...
from app.api.v1.routes.user_invitations.user_invitations import router as user_invitations_router
from app.api.v1.routes.access_control.users_groups import router as users_groups_router
...
#include user_invitations routes
api_v1_router.include_router(
    user_invitations_router,
    prefix="/user_invitations",
    tags=["user_invitations"]
)

#include users_group routes
api_v1_router.include_router(
    users_groups_router,
    prefix="/users_group",
    tags=["users_group"]
