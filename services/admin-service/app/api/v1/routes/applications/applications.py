    ...
    try:
        ...
        for a in applications:
            app_dict = {
                ...
                "is_selling": getattr(a, 'is_selling', False),
                ...
                "nav_group": getattr(a, 'nav_group', None),
...
async def get_menus_by_application(
    ...
    if not application_doc:
        ...
        application_doc = {
            ...
            "nav_group": application.nav_group or "apps",
    ...
    apps_list = [
        {
            ...
            "is_selling": getattr(app, 'is_selling', False),
            "key": app.key,
            "label": app.label,
            "route": app.route,
            "icon": app.icon,
