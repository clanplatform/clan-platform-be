...
# NOTE: time_zone may be supplied (branch "Timezone"); when omitted it is
# autogenerated from country_code. time_zone_offset / date_format / time_format /
...
class EntityResponse(EntityBase):
    entity_id: UUID
    # Autogenerated server-side (read-only); time_zone is inherited from the base.
