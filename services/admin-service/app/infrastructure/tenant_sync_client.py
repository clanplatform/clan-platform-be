...
def sync_tenant_profile(
    *,
    ...
    """
    Push client data to clan-tenant-portal-be so TenantProfile stays in sync.
    ...
    try:
        ...
        logger.error(f"[tenant-sync] sync_tenant_profile failed for client {client_id}: {exc}")
